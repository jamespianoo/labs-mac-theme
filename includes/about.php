<template id="tpl-about" data-title="about-me.pdf" data-w="580" data-h="430" data-info="Read only|jamesbeckwith.com">
  <div class="doc">
    ...
    <hr>
    <p>Away from the piano stool: restoring Rhodes, Wurlitzer and Clavinet, tuning acoustics across south east London, and building map-based compositions — the Underground as a synthesiser, venues that no longer exist, the solar system as a score. Open Labs for the weird drawer.</p>
  </div>
</template>
